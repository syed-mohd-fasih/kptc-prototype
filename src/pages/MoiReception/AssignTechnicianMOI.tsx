...
const mockTechnicians = ["Ali Yousuf", "Sameer Hasan", "Nora Khaled", "Reem Saeed"]
...
export default function AssignTechnicianMOI() {
    ...
    return (
        <div className="p-4">
            {/* <h2 className="text-2xl font-bold mb-4">Assign Technician - MOI</h2> */}
            <Input
                type="text"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            console.log(
                                                `Assigned ${selectedTechnician} to ${selectedCard?.jcno}`
                                            )
